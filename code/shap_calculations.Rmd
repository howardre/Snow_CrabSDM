...
```{r}
r2pmml(brt_leg_male_abun$model, 
       here('data', 'brt_leg_male_abun.pmml'))
```
...
import json
r = R(use_pandas = True)
model_rds_path = "brt_leg_male_abun.rds"
r.assign("rmodel", model_rds_path)



model <- readRDS(rmodel)
```
...
model = Model.fromFile('brt_leg_male_abun.pmml')
