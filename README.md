...
- The **Bering10K ROMS** output. We are using the latest CMIP6 runs to obtain values for temperature <img align = 'right' src = 'results/grain_size.jpg' width = '200'> in order to predict next season distributions. These outputs are [publicly available](https://beringnpz.github.io/roms-bering-sea/B10K-dataset-docs/). 
...
<img align = 'center' src = 'results/RMSE_plot.png' width = '300'>
