...
This is part of a NOAA funded project that creates updated species distribution maps for snow crab in the northern Bering Sea. This repository serves as a tool to continue to create updated SDMs for snow crab by sex and maturity will be used forecast next-season summer distributions. A portion of this work comprises a chapter of my Ph.D. dissertation. The final models can be rerun using this [script](code/final_SDM.R).
