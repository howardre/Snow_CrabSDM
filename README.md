...
Delta-type BRTs were developed in a <img align = 'right' src = 'results/BRT/multipanel.png' width = '550'> similar manner to the delta-type GAMs. Predicted abundance for these models was also conditional on the presence-absence from the Bernoulli model. The final predicted plots of distribution look like this:
